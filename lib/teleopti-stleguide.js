...
module.exports = {
  ...
  activate: function(state) {
    ...
    return workspace.command('teleopti-stleguide:toggleBackground', (function(_this) {
      return function() {
        return _this.toggleBackground();
      };
    })(this));
  },
  ...
  toggleBackground: function() {
    ...
    workspace = atom.workspaceView;
    return workspace.find('.item-views > .editor > .scroll-view').toggleClass('yeoman');
  }
};
